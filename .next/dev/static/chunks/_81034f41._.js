...
function ChristmasTreeHero() {
    ...
    const currentStepRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0) // Track step for sequential messages
    ;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChristmasTreeHero.useEffect": ()=>{
            ...
            const drawGiftBox = {
                "ChristmasTreeHero.useEffect.drawGiftBox": (ctx, x, y, size, scale, colorIndex, isHovered, openAnimation, floatOffset, _sparklePhase, isBouncing, bounceStartTime, alpha = 1)=>{
            ...
            }["ChristmasTreeHero.useEffect.drawGiftBox"];
            // Spawn subtle particles when gift opens
            const spawnParticles = {
                "ChristmasTreeHero.useEffect.spawnParticles": (x, y, count)=>{
                    const colors = [
                        "#ffd700",
                        "#fff8dc",
                        "#ffffff"
            ...
            }["ChristmasTreeHero.useEffect.spawnParticles"];
            // Update and draw particles
            const updateParticles = {
                "ChristmasTreeHero.useEffect.updateParticles": (ctx)=>{
                    particlesRef.current = particlesRef.current.filter({
                        "ChristmasTreeHero.useEffect.updateParticles": (p)=>p.life > 0.01
                    }["ChristmasTreeHero.useEffect.updateParticles"]);
            ...
            const handleMouseDown = {
                "ChristmasTreeHero.useEffect.handleMouseDown": (e)=>{
                    ...
                    const clickedGift = projectedGifts.find({
                        "ChristmasTreeHero.useEffect.handleMouseDown.clickedGift": (g)=>{
                            const { hitBox } = g;
                    ...
                    }["ChristmasTreeHero.useEffect.handleMouseDown.clickedGift"]);
                    if (clickedGift) {
                        ...
                        const unopenedGifts = giftBoxesRef.current.filter({
                            "ChristmasTreeHero.useEffect.handleMouseDown.unopenedGifts": (g)=>!g.isOpened
                        }["ChristmasTreeHero.useEffect.handleMouseDown.unopenedGifts"]);
                        const now = Date.now();
                        // Pick 2-3 random unopened gifts to bounce
                        const bouncingCount = Math.min(3, unopenedGifts.length);
                        const shuffled = unopenedGifts.sort({
                            "ChristmasTreeHero.useEffect.handleMouseDown.shuffled": ()=>Math.random() - 0.5
                        }["ChristmasTreeHero.useEffect.handleMouseDown.shuffled"]);
                        // Reset all bouncing first
                        giftBoxesRef.current.forEach({
                            "ChristmasTreeHero.useEffect.handleMouseDown": (g)=>g.isBouncing = false
                        ...
                        }["ChristmasTreeHero.useEffect.handleMouseDown"], 4000);
                        return;
                    }
            ...
            const handleMouseMove = {
                "ChristmasTreeHero.useEffect.handleMouseMove": (e)=>{
                    ...
                    const hoveredGift = projectedGifts.findIndex({
                        "ChristmasTreeHero.useEffect.handleMouseMove.hoveredGift": (g)=>{
                            const { hitBox } = g;
                            return e.clientX >= hitBox.minX && e.clientX <= hitBox.maxX && e.clientY >= hitBox.minY && e.clientY <= hitBox.maxY && zoomRef.current >= g.gift.zoomThreshold && !g.gift.isOpened;
                        }
                    }["ChristmasTreeHero.useEffect.handleMouseMove.hoveredGift"]);
...
_s(ChristmasTreeHero, "m8CRbbTTdLST41iu7TeuNj1bCYc=");
